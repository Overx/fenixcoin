...
See `doc/readme-qt.rst` for instructions on building Fenixcoin-Qt, the
...
on an OS X 10.6 64-bit machine fails. Official release builds of Fenixcoin-Qt are
compiled on an OS X 10.6 32-bit machine to workaround that problem.

Once dependencies are compiled, creating `Fenixcoin-Qt.app` is easy:

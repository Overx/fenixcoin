...
isEmpty(QMAKE_LRELEASE) {
    win32:QMAKE_LRELEASE = $$[QT_INSFNXL_BINS]\\lrelease.exe
    else:QMAKE_LRELEASE = $$[QT_INSFNXL_BINS]/lrelease
}
...
macx:ICON = src/qt/res/icons/fenixcoin.icns

...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Fenixcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed.fenixcoin.in", "seed.fenixcoin.in"},
    {"138.197.77.151", "138.197.77.151"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Fenixcoin is probably already running."), addrBind.ToString().c_str());
        else
